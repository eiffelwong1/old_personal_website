...
function AboutMe() {
    return (
        <Container>
            <div className="face">
                <img src="my_face.jpg" alt="my face" width="200" height="200" />
            </div>

            <div className="intro">
                <h1>Hi There,</h1>
                <p>I'm Sing Wong, a full-stack software engineer with a strong background in ML, bringing over 2.5 years of experience to the table.</p>
            </div>
            ...
            <div className="custom-shape-divider-top-1678921490">
            ...
            <div className="bio">
                ...
                <Bio title='Software Engineer @ Eightfold AI' year="Apr2022-Feb2023"></Bio>
